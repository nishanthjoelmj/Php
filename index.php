          ...
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
               ...
               if (!empty($_POST["ename"])) {
                    ...
                    if (!filter_var($_POST["ename"], FILTER_VALIDATE_EMAIL)) {
                         echo " <script> alert('Invalid Email Address or Not registered For Exam') </script> ";
                    }
               }
               ...
               if (strlen($_POST['Cnumber']) != 5) {
                    echo ("  <script> alert('Number must be greater than 10 and numeric only') </script>");
               }
